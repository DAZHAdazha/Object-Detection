      ...
      <div id="CT_image">
        <el-card id="CT_image_1" class="box-card" style="
          ...
          <div class="demo-image__preview2">
            <div v-loading="loading" element-loading-text="Program is processing, please wait"
            ...
            <div class="img_info_1" style="border-radius: 0 0 5px 5px">
              <span style="color: white; letter-spacing: 0px">Result</span>
            </div>
          </div>
        </el-card>
      </div>
        ...
        <el-card style="border-radius: 8px">
          ...
          <el-tabs v-model="activeName">
            <el-tab-pane label="Detected Objects" name="first">
              <!-- 表格存放特征值 -->
              <el-table :data="feature_list" height="390" border style="width: 1000px; text-align: center"
                v-loading="loading" element-loading-text="Data is processing, please wait"
                element-loading-spinner="el-icon-loading" lazy>
                <el-table-column label="Object Class" width="333px">
                  <template slot-scope="scope">
                    <span>{{ scope.row[2] }}</span>
                  </template>
                </el-table-column>
                <el-table-column label="Object Size" width="333px">
                  <template slot-scope="scope">
                    <span>{{ scope.row[0] }}</span>
                  </template>
                </el-table-column>
                <el-table-column label="Confidence" width="333px">
                  <template slot-scope="scope">
