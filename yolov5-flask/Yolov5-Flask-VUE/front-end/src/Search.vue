        ...
        <div class="sidebar">
          ...
          <ul class="sidebar-list">
            ...
            <li class="sidebar-list-item active">
              <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewbox="0 0 24 24" fill="none"
                  stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                  class="feather feather-shopping-bag">
                  <path d="M6 2L3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"></path>
                  <line x1="3" y1="6" x2="21" y2="6"></line>
                  <path d="M16 10a4 4 0 0 1-8 0"></path>
                </svg> <span>Images</span></a>
            </li>
            <router-link to="/login">
              <li class="sidebar-list-item">
                <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewbox="0 0 24 24"
                  ...
                  </svg> <span>Sign up/Log in</span></a>
              </li>
            </router-link>
          </ul>
        ...
        <div class="app-content">
          <div class="app-content-header">
            <h1 class="app-content-headerText">
              Images
            </h1><button class="mode-switch" title="Switch Theme"><svg class="moon" fill="none" stroke="currentColor"
                stroke-linecap="round" stroke-linejoin="round" stroke-width="2" width="24" height="24"
                viewbox="0 0 24 24">
                <defs></defs>
                <path d="M21 12.79A9 9 0 1111.21 3 7 7 0 0021 12.79z"></path>
              </svg></button> <button @click="myfunLogout" class="app-content-headerButton">Log Out</button>
          </div>
          <div class="app-content-actions">
            <input style="display:none;" class="search-bar" placeholder="Search..." type="text">
            <div class="app-content-actions-wrapper">
              <button class="action-button list active" title="List View"><svg xmlns="http://www.w3.org/2000/svg"
                ...
                </svg></button> <button class="action-button grid" title="Grid View"><svg
          ...
          <div class="products-area-wrapper tableView">
            ...
            <div class="products-row" v-for="imageset in imagesets">
              ...
              <button class="cell-more-button"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18"
              ...
              <div class="product-cell image">
                <img style="cursor:pointer" v-viewer :src="require(`../../back-end/tmp/draw/${imageset[1]}`)"
                  alt="product"> <span>{{ imageset[1] }}</span>
              </div>
              <div class="product-cell category">
              ...
              <div class="product-cell status-cell">
                ...
                <span @click="mydelete" style="margin-left:80px;">
  ...
  export default {
    ...
    methods: {
      mydelete: function (event) {
        ...
        httpRequest.open('POST', 'http://127.0.0.1:5003/delete', true);
        httpRequest.setRequestHeader("Content-type", "application/json");
        var obj = {
          username: this.user,
          imagename: thisimage.parentNode.parentNode.firstChild.nextSibling.firstChild.nextSibling.innerHTML
        };
      ...
      myfunLogout: function () {
        var httpRequest = new XMLHttpRequest();
        httpRequest.open('POST', 'http://127.0.0.1:5003/logout', true);
        httpRequest.setRequestHeader("Content-type", "application/json");
        httpRequest.send();
        httpRequest.onreadystatechange = () => {
          if (httpRequest.readyState == 4 && httpRequest.status == 200) {
      ...
      httpRequest.onreadystatechange = () => {
        if (httpRequest.readyState == 4 && httpRequest.status == 200) {
          ...
          if (json == '0') {
            ...
            newhttpRequest.open('POST', 'http://127.0.0.1:5003/images',
              true);
            newhttpRequest.setRequestHeader("Content-type", "application/json");
            var newobj = {
              username: this.user
            };
            newhttpRequest.send(JSON.stringify(newobj));
            newhttpRequest.onreadystatechange = () => {
              if (newhttpRequest.readyState == 4 && newhttpRequest.status == 200) {
                var newjson = newhttpRequest.responseText;
